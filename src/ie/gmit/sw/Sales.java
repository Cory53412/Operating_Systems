...
public class Sales {
	...
	public Sales(String name, String age, String machineID, String clubID, String vendor, String valuation,
			String lastServiceKM, String nextServiceinKM, String currentkm, String saleprice) {
		super();
		this.name = name;
		this.age = age;
